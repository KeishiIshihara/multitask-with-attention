# Code is borrowed from: https://github.com/qubvel/classification_models/blob/master/classification_models/models/resnet.py
...
def ResNet(model_params, input_shape=None, input_tensor=None, include_top=True,
    ...
    # Create model.
    model = models.Model(inputs, x, name=model_params.model_name)

    if weights and False:
...
class ModelsFactory(object):
    _models = {
        ...
        # ResNets
        'resnet18': [ResNet18, preprocess_input],
        'resnet34': [ResNet34, preprocess_input],
        'resnet50': [ResNet50, preprocess_input],
        'resnet101': [ResNet101, preprocess_input],
        'resnet152': [ResNet152, preprocess_input],
    ...
    def get(cls, name):
        ...
        model_fn, preprocess_input = cls._models[name]
        return model_fn
...
if __name__ == '__main__':
    ...
    """
    ResNet34 = ModelsFactory.get('resnet34')
    resnet = ResNet34(input_shape=(128, 224, 3), include_top=False)
    resnet.summary()
    # tf.keras.utils.plot_model(resnet, to_file='resnet34.png', show_shapes=True)
